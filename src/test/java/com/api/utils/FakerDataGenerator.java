...
public class FakerDataGenerator 
{
	...
	public static CreateJobPayload generateFakeCreateJobData()
	{
		...
		CustomerProduct custProduct = generateFakeCustomerProductData();
		List<Problems> problems = generateFakeProblemList();
		CreateJobPayload payload = new CreateJobPayload(MST_SERVICE_LOCATION_ID, MST_PLATFORM_ID, MST_WARRENTY_STATUS_ID, MST_OEM_ID, customer, customerAddress, custProduct, problems);
		return payload;
	}
	...
	@Step("Generating Fake Customer Product for info")
	private static CustomerProduct generateFakeCustomerProductData() 
	{
		String dop = DateTimeUtil.getTimeWithDaysAgo(10);
        String imeiSerialNumber = faker.numerify("###############");
        String popUrl = faker.internet().url();
        CustomerProduct custProduct = new CustomerProduct(dop, imeiSerialNumber, imeiSerialNumber, imeiSerialNumber, popUrl, PRODUCT_ID, MST_MODEL_ID);
        return custProduct;
	}

	@Step("Generating Fake Create data info")
	...
	@Step("Generating Fake Create address data")
